...
*Policies : Policies &gt; Application Override : Application Override General Tab*
...
| Audit Comment | Enter a comment to audit the creation or editing of the policy rule. The audit comment s case-sensitive and can have up to 256 characters, which can be letters, numbers, spaces, hyphens, and underscores. |
