      ...
      vmseries_public = {
        ...
        rules = {
          ...
          ssh = {
            ...
            type        = "ingress", from_port = "22", to_port = "22", protocol = "tcp"
            cidr_blocks = ["YOUR-PUBLIC-IP/32", "10.104.0.0/21", "10.105.0.0/21"]
          }
          https = {
      ...
      app1_vm = {
        ...
        rules = {
          ...
          ssh = {
            description = "Permit SSH"
            type        = "ingress", from_port = "22", to_port = "22", protocol = "tcp"
            cidr_blocks = ["YOUR-PUBLIC-IP/32", "10.50.0.0/23", "10.104.0.0/21", "10.105.0.0/21"]
          }
          https = {
            description = "Permit HTTPS"
            type        = "ingress", from_port = "443", to_port = "443", protocol = "tcp"
          ...
          icmp = {
            ...
            type        = "ingress", from_port = "-1", to_port = "-1", protocol = "icmp"
            cidr_blocks = ["10.104.0.0/21", "10.105.0.0/21"]
          }
        }
      }
    }
