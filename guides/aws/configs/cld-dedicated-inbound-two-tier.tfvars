...
#
#   The most separated architecture, combining two independent dimensions:
#
#   - Dual security VPCs: OBEW and Inbound firewall pools scale and fail
#     independently
#   - Dedicated inbound VPC: Centralizes all internet-facing infrastructure
#     away from spoke workloads
#
#   - security_obew_vpc:    Handles OUTBOUND and EAST-WEST inspection
#   - security_inbound_vpc: Handles INBOUND inspection only
#   - inbound_vpc:          Internet entry point (IGW, GWLBE, NLBs)
#
#   Traffic flows:
#
#   - INBOUND:   Internet -> Inbound VPC IGW -> GWLBE -> GWLB -> VM-Series
#                (security_inbound_vpc) -> GWLBE -> Inbound NLB -> TGW ->
#                Spoke NLB -> Spoke VM
#
...
#
#   VPCs: 5 (security_obew + security_inbound + inbound + 2 spokes)
#   GWLBs: 2 | VM-Series groups: 2 | TGW route tables: 3
#
# #############################################################################

### GENERAL
region      = "us-west-2"
name_prefix = "cld-ded2t-"
...
### SPOKE ALBs (not used in dedicated inbound design with dual security VPCs)
spoke_albs = {}
