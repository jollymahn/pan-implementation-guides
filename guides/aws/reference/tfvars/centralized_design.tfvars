# Reference tfvars for the SWFW centralized_design example, re-CIDR'd to follow
...
#   - security_vpc CIDR: 10.100.0.0/16 -> 10.51.0.0/22
#     8 schema groups x 4 AZ slots /28 each, plus alb + nlb extended into the
#     upper half of each /24 (.128/28, .144/28) since centralized_design
#     publishes its ALB/NLB out of the security VPC.
...
vpcs = {
  security_vpc = {
      ...
      vmseries_public = {
        ...
        rules = {
          ...
          health_probe_8081 = {
            ...
            cidr_blocks = ["10.51.0.128/28", "10.51.1.128/28", "10.51.2.128/28", "10.51.3.128/28"]
          }
          health_probe_8082 = {
          ...
          health_probe_2021 = {
            ...
            cidr_blocks = ["10.51.0.144/28", "10.51.1.144/28", "10.51.2.144/28", "10.51.3.144/28"]
          }
          health_probe_2022 = {
    ...
    subnets = {
      ...
      # alb and nlb extended into the upper half of each /24 (.128 and .144 offsets).
      ...
      # SUBNET-8-128-ALB (extension beyond schema for centralized_design publish path)
      "10.51.0.128/28" = { az = "us-east-2a", subnet_group = "alb" }
      "10.51.1.128/28" = { az = "us-east-2b", subnet_group = "alb" }
      "10.51.2.128/28" = { az = "us-east-2a", subnet_group = "alb" }
      "10.51.3.128/28" = { az = "us-east-2b", subnet_group = "alb" }

      # SUBNET-9-144-NLB (extension beyond schema for centralized_design publish path)
      "10.51.0.144/28" = { az = "us-east-2a", subnet_group = "nlb" }
      "10.51.1.144/28" = { az = "us-east-2b", subnet_group = "nlb" }
      "10.51.2.144/28" = { az = "us-east-2a", subnet_group = "nlb" }
      "10.51.3.144/28" = { az = "us-east-2b", subnet_group = "nlb" }
    }
    routes = {
